...
public class ZclGroupsClient extends ZclServiceCluster implements GroupsClient, ZigBeeDeviceListener {
	...
	protected IZclFrame parseGetGroupMembership(GroupsServer o, IZclFrame zclFrame) throws ApplianceException, ServiceClusterException {
	...
	protected IZclFrame parseAddGroupIfIdentifying(GroupsServer o, IZclFrame zclFrame) throws ApplianceException, ServiceClusterException {
		int GroupID = ZclDataTypeUI16.zclParse(zclFrame);
		String GroupName = ZclDataTypeString.zclParse(zclFrame);
