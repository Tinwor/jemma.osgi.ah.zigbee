...
public class ZclAirQualityServer extends ZclServiceCluster implements AirQualityServer, ZigBeeDeviceListener {
	...
	protected IZclFrame parseExternalAirQualityIndexNotification(org.energy_home.jemma.ah.cluster.zigbee.lube.AirQualityClient o, IZclFrame zclFrame) throws ApplianceException,
